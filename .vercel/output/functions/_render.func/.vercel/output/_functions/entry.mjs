...
const _page1 = () => import('./pages/api/github.astro.mjs');
const _page2 = () => import('./pages/api/wordpress.astro.mjs');
const _page3 = () => import('./pages/background.astro.mjs');
const _page4 = () => import('./pages/blog.astro.mjs');
const _page5 = () => import('./pages/blogpage.astro.mjs');
const _page6 = () => import('./pages/de/background.astro.mjs');
const _page7 = () => import('./pages/de/blog.astro.mjs');
const _page8 = () => import('./pages/de/blogpage.astro.mjs');
const _page9 = () => import('./pages/de/experience.astro.mjs');
const _page10 = () => import('./pages/de/photography.astro.mjs');
const _page11 = () => import('./pages/de/portfoliopage.astro.mjs');
const _page12 = () => import('./pages/de/projectpage.astro.mjs');
const _page13 = () => import('./pages/de/projects.astro.mjs');
const _page14 = () => import('./pages/de/resume.astro.mjs');
const _page15 = () => import('./pages/de/skills.astro.mjs');
const _page16 = () => import('./pages/de.astro.mjs');
const _page17 = () => import('./pages/en/background.astro.mjs');
const _page18 = () => import('./pages/en/blog.astro.mjs');
const _page19 = () => import('./pages/en/blogpage.astro.mjs');
const _page20 = () => import('./pages/en/experience.astro.mjs');
const _page21 = () => import('./pages/en/photography.astro.mjs');
const _page22 = () => import('./pages/en/portfoliopage.astro.mjs');
const _page23 = () => import('./pages/en/projectpage.astro.mjs');
const _page24 = () => import('./pages/en/projects.astro.mjs');
const _page25 = () => import('./pages/en/resume.astro.mjs');
const _page26 = () => import('./pages/en/skills.astro.mjs');
const _page27 = () => import('./pages/en.astro.mjs');
const _page28 = () => import('./pages/experience.astro.mjs');
const _page29 = () => import('./pages/photography.astro.mjs');
const _page30 = () => import('./pages/portfoliopage.astro.mjs');
const _page31 = () => import('./pages/projectpage.astro.mjs');
const _page32 = () => import('./pages/projects.astro.mjs');
const _page33 = () => import('./pages/resume.astro.mjs');
const _page34 = () => import('./pages/skills.astro.mjs');
const _page35 = () => import('./pages/index.astro.mjs');

const pageMap = new Map([
    ["node_modules/astro/dist/assets/endpoint/generic.js", _page0],
    ["src/pages/api/github.ts", _page1],
    ["src/pages/api/wordpress.ts", _page2],
    ["src/pages/Background.astro", _page3],
    ["src/pages/Blog.astro", _page4],
    ["src/pages/BlogPage.astro", _page5],
    ["src/pages/de/Background.astro", _page6],
    ["src/pages/de/Blog.astro", _page7],
    ["src/pages/de/BlogPage.astro", _page8],
    ["src/pages/de/Experience.astro", _page9],
    ["src/pages/de/Photography.astro", _page10],
    ["src/pages/de/PortfolioPage.astro", _page11],
    ["src/pages/de/ProjectPage.astro", _page12],
    ["src/pages/de/Projects.astro", _page13],
    ["src/pages/de/Resume.astro", _page14],
    ["src/pages/de/Skills.astro", _page15],
    ["src/pages/de/index.astro", _page16],
    ["src/pages/en/Background.astro", _page17],
    ["src/pages/en/Blog.astro", _page18],
    ["src/pages/en/BlogPage.astro", _page19],
    ["src/pages/en/Experience.astro", _page20],
    ["src/pages/en/Photography.astro", _page21],
    ["src/pages/en/PortfolioPage.astro", _page22],
    ["src/pages/en/ProjectPage.astro", _page23],
    ["src/pages/en/Projects.astro", _page24],
    ["src/pages/en/Resume.astro", _page25],
    ["src/pages/en/Skills.astro", _page26],
    ["src/pages/en/index.astro", _page27],
    ["src/pages/Experience.astro", _page28],
    ["src/pages/Photography.astro", _page29],
    ["src/pages/PortfolioPage.astro", _page30],
    ["src/pages/ProjectPage.astro", _page31],
    ["src/pages/Projects.astro", _page32],
    ["src/pages/Resume.astro", _page33],
    ["src/pages/Skills.astro", _page34],
...
const _args = {
    "middlewareSecret": "a24cd98c-2f7b-416b-89b8-843768f72fac",
